...
const ROUTE_RULES: RouteRateLimitRule[] = [
    ...
    { routeId: "cart-list", method: "GET", pathPattern: "/cart/my", tiers: [AUTHENTICATED_READ] },
    { routeId: "cart-item-add", method: "POST", pathPattern: "/cart/items", tiers: [GENERIC_WRITE] },
    { routeId: "cart-item-update", method: "PUT", pathPattern: "/cart/items/:productId", tiers: [GENERIC_WRITE] },
    { routeId: "cart-item-delete", method: "DELETE", pathPattern: "/cart/items/:productId", tiers: [GENERIC_WRITE] },
    { routeId: "cart-merge", method: "POST", pathPattern: "/cart/merge", tiers: [GENERIC_WRITE] },
